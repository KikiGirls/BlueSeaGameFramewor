...
namespace BlueSeaGameFramework.Network.Client
{
    ...
    public class NetEvent : Singleton<NetEvent>
    {
        ...
        private readonly ConcurrentDictionary<IMessageId, Delegate> eventHandlers = new();
        ...
        public void Dispatch<T>(IMessageId msgId, MessageWrapper<T> message) where T : IMessage, new()
        {
            // 参数检查
            if (msgId == null) throw new ArgumentNullException(nameof(msgId));
